...
class FungalTreatmentsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('fungal-treatments')->with('flash_message', 'FungalTreatment added!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('fungal-treatments')->with('flash_message', 'FungalTreatment updated!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('fungal-treatments')->with('flash_message', 'FungalTreatment deleted!');
    }
}
